...
import { Room_typeInterface } from "../models/IRoom_type";
import { Room_priceInterface } from "../models/IRoom_price";
import { Set_of_furnitureInterface } from "../models/ISet_of_furniture";
